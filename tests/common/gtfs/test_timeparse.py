...
class TestComputeServiceDate:
    ...
    @pytest.mark.parametrize("event_dt, scheduled_sec, expected_date", [
...
class TestComputePlannedTime:
    ...
    @pytest.mark.parametrize("service_date, scheduled_sec, expected_tuple", [
...
class TestComputeDelaySeconds:
    ...
    @pytest.mark.parametrize("event_dt, planned_dt, expected_delay", [
